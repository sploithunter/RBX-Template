...
return {
    ...
    powers = {
        ...
        hasten = { generic = true, focus_cost = 20, cooldown_seconds = 60, effect = "recharge", unlock_level = 14 },
        xp_surge = { generic = true, focus_cost = 25, cooldown_seconds = 60, effect = "xp_boost", unlock_level = 4 },
        revive = { generic = true, focus_cost = 25, cooldown_seconds = 30, effect = "revive", unlock_level = 10 },
        recall = { generic = true, focus_cost = 10, cooldown_seconds = 30, effect = "recall", unlock_level = 20 },
