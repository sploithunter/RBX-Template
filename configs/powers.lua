...
return {
    ...
    powers = {
        ...
        fortune = { generic = true, focus_cost = 20, cooldown_seconds = 45, effect = "luck", unlock_level = 2 },
        huge_fortune = {
            generic = true,
            focus_cost = 50,
        ...
        swift = { generic = true, focus_cost = 15, cooldown_seconds = 25, effect = "move_speed", unlock_level = 2 },
        hasten = { generic = true, focus_cost = 20, cooldown_seconds = 60, effect = "recharge", unlock_level = 4 },
        xp_surge = { generic = true, focus_cost = 25, cooldown_seconds = 60, effect = "xp_boost", unlock_level = 6 },
        revive = { generic = true, focus_cost = 25, cooldown_seconds = 30, effect = "revive", unlock_level = 8 },
        recall = { generic = true, focus_cost = 10, cooldown_seconds = 30, effect = "recall", unlock_level = 6 },
        magnet = { generic = true, focus_cost = 15, cooldown_seconds = 30, effect = "magnet", unlock_level = 2 },
        world_travel = {
            generic = true,
            focus_cost = 10,
            cooldown_seconds = 30,
