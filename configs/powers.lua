...
return {
    ...
    powers = {
        ...
        windfall = { generic = true, focus_cost = 30, cooldown_seconds = 60, effect = "windfall", unlock_level = 6, subtitle = "Always-On" },
        ...
        fortune = { generic = true, focus_cost = 20, cooldown_seconds = 45, effect = "luck", unlock_level = 8, subtitle = "Player-Targeted Special" },
        huge_fortune = {
            generic = true,
            focus_cost = 50,
        ...
        swift = { generic = true, focus_cost = 15, cooldown_seconds = 25, effect = "move_speed", unlock_level = 2, subtitle = "Always-On" },
        hasten = { generic = true, focus_cost = 20, cooldown_seconds = 60, effect = "recharge", unlock_level = 14, subtitle = "Always-On" },
        xp_surge = { generic = true, focus_cost = 25, cooldown_seconds = 60, effect = "xp_boost", unlock_level = 4, subtitle = "Always-On" },
        revive = { generic = true, focus_cost = 25, cooldown_seconds = 30, effect = "revive", unlock_level = 10, subtitle = "Single-Target Health" },
        recall = { generic = true, focus_cost = 10, cooldown_seconds = 30, effect = "recall", unlock_level = 20, subtitle = "Player-Targeted Travel" },
        magnet = { generic = true, focus_cost = 15, cooldown_seconds = 30, effect = "magnet", unlock_level = 2, subtitle = "Always-On" },
        world_travel = {
            generic = true,
            focus_cost = 10,
            cooldown_seconds = 30,
        ...
        mirage_step = { archetype = "sandwalker", focus_cost = 15, cooldown_seconds = 20, effect = "dodge", display_name = "Mirage Step", subtitle = "Self Dodge Buff", role = "buff", element = "desert", target = "single_pet", glyph = "buff", unlock_level = 6 },
        dune_shield = { archetype = "sandwalker", focus_cost = 18, cooldown_seconds = 30, effect = "shield", display_name = "Dune Shield", subtitle = "Single-Pet Shield", role = "shield", element = "desert", target = "single_pet", glyph = "shield", unlock_level = 6 },
        restoring_sands = { archetype = "sandwalker", focus_cost = 20, cooldown_seconds = 25, effect = "restoring_sands", display_name = "Restoring Sands", subtitle = "Single-Pet Heal", role = "heal", element = "desert", target = "single_pet", glyph = "heal", unlock_level = 6 },
        expose = { archetype = "sandwalker", focus_cost = 15, cooldown_seconds = 20, effect = "expose", display_name = "Expose", subtitle = "Single-Target Debuff", role = "debuff", element = "desert", target = "single", glyph = "debuff", unlock_level = 9 },
        sandstorm = { archetype = "sandwalker", focus_cost = 35, cooldown_seconds = 50, effect = "aoe_blind", display_name = "Sandstorm", subtitle = "AoE Blind Debuff", role = "debuff", element = "desert", target = "targeted_aoe", glyph = "debuff", unlock_level = 9 },
        fear = { archetype = "sandwalker", focus_cost = 25, cooldown_seconds = 35, effect = "fear", display_name = "Fear", subtitle = "Single-Target Fear", role = "control", element = "desert", target = "single", glyph = "control", unlock_level = 12 },
        healing_field = { archetype = "sandwalker", focus_cost = 35, cooldown_seconds = 45, effect = "healing_field", display_name = "Healing Field", subtitle = "Self-AoE Heal", role = "heal", element = "desert", target = "player_field", glyph = "heal", unlock_level = 12 },

        -- Cryomancer (ice · controller): control trio (root/disarm/hold), armor, vuln, damage, field
        frost_bind = { archetype = "cryomancer", focus_cost = 25, cooldown_seconds = 35, effect = "root", display_name = "Frost Bind", subtitle = "Single-Target Root", role = "control", element = "ice", target = "single", glyph = "control", unlock_level = 6 },
        ice_armor = { archetype = "cryomancer", focus_cost = 20, cooldown_seconds = 30, effect = "armor", display_name = "Ice Armor", subtitle = "Single-Pet Armor", role = "armor", element = "ice", target = "single_pet", glyph = "shield", unlock_level = 6 },
        disarm = { archetype = "cryomancer", focus_cost = 18, cooldown_seconds = 25, effect = "disarm", display_name = "Disarm", subtitle = "Single-Target Disarm", role = "control", element = "ice", target = "single", glyph = "control", unlock_level = 6 },
        focus_fire = { archetype = "cryomancer", focus_cost = 12, cooldown_seconds = 15, effect = "focus_fire", display_name = "Focus Fire", subtitle = "Single-Target Debuff", role = "debuff", element = "ice", target = "single", glyph = "debuff", unlock_level = 9 },
        ice_shard = { archetype = "cryomancer", focus_cost = 14, cooldown_seconds = 12, effect = "ice_shard", display_name = "Ice Shard", subtitle = "Single-Target Damage", role = "damage", element = "ice", target = "single", glyph = "burst", unlock_level = 9 },
        deep_freeze = { archetype = "cryomancer", focus_cost = 28, cooldown_seconds = 40, effect = "deep_freeze", display_name = "Deep Freeze", subtitle = "Single-Target Hold", role = "control", element = "ice", target = "single", glyph = "control", unlock_level = 12 },
        frost_field = { archetype = "cryomancer", focus_cost = 35, cooldown_seconds = 45, effect = "frost_field", display_name = "Frost Field", subtitle = "Self-AoE Freeze", role = "control", element = "ice", target = "player_field", glyph = "control", unlock_level = 12 },

        -- Pyromancer (lava · damage): strike, DoT, shield, AoE, crit buff, Scorch, Fire Nova
        strike = { archetype = "pyromancer", focus_cost = 10, cooldown_seconds = 12, effect = "strike", display_name = "Strike", subtitle = "Single-Target Damage", role = "damage", element = "lava", target = "single", glyph = "burst", unlock_level = 6 },
        mark_of_flame = { archetype = "pyromancer", focus_cost = 20, cooldown_seconds = 25, effect = "damage_over_time", display_name = "Mark of Flame", subtitle = "Single-Target DoT", role = "damage", element = "lava", target = "single", glyph = "debuff", unlock_level = 6 },
        ember_ward = { archetype = "pyromancer", focus_cost = 20, cooldown_seconds = 30, effect = "shield", display_name = "Ember Ward", subtitle = "Single-Pet Shield", role = "shield", element = "lava", target = "single_pet", glyph = "shield", unlock_level = 6 },
        eruption = { archetype = "pyromancer", focus_cost = 45, cooldown_seconds = 60, effect = "aoe_damage", display_name = "Eruption", subtitle = "AoE Damage", role = "damage", element = "lava", target = "targeted_aoe", glyph = "burst", unlock_level = 9 },
        critical_strike = { archetype = "pyromancer", focus_cost = 30, cooldown_seconds = 40, effect = "crit_up", display_name = "Critical Strike", subtitle = "Team Crit Buff", role = "buff", element = "lava", target = "team_aoe", glyph = "buff", unlock_level = 9 },
        scorch = { archetype = "pyromancer", focus_cost = 16, cooldown_seconds = 18, effect = "scorch", display_name = "Scorch", subtitle = "Single-Target Debuff", role = "debuff", element = "lava", target = "single", glyph = "debuff", unlock_level = 12 },
        fire_nova = { archetype = "pyromancer", focus_cost = 40, cooldown_seconds = 50, effect = "fire_nova", display_name = "Fire Nova", subtitle = "Self-AoE Burn", role = "damage", element = "lava", target = "player_field", glyph = "burst", unlock_level = 12 },
