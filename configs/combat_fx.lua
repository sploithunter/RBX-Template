...
return {
    ...
    origin = {
        ...
        pettype_element = {
            ...
            bear = "grass",
            kitty = "ice",
            dragon = "desert", -- TEMP VFX test override (real origin = grass): cycling the test dragon
            -- through elements to polish each burst+burn. Restore to "grass" once VFX is signed off.
            colorado = "lava",
