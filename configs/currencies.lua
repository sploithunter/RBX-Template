...
return {
  ...
  { id = "grass_coins", name = "Grass Coins", description = "Grass (earth) biome currency", maxAmount = 999999999, defaultAmount = 100, icon = "🌿", tradeable = false }, -- 100 starter grant: funds the first EarthEgg hatch before mining
  ...
  { id = "beach_coins", name = "Beach Coins", description = "Beach biome currency", maxAmount = 999999999, defaultAmount = 0, icon = "🏖️", tradeable = false },
  { id = "light_tokens", name = "Light Tokens", description = "Heaven layer token (Halo)", maxAmount = 999999, defaultAmount = 0, icon = "😇", tradeable = false },
  { id = "shadow_tokens", name = "Shadow Tokens", description = "Hell layer token (Horns)", maxAmount = 999999, defaultAmount = 0, icon = "😈", tradeable = false },
}